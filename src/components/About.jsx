...
export default function About() {
  return (
    <section id="about" className="py-24 md:py-32 border-t border-[#e5e7eb] dark:border-[#27272a]">
      <div className="max-w-5xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h2 className="text-3xl md:text-[40px] font-bold leading-tight tracking-tight text-[#111111] dark:text-white mb-6">
              Bridging healthcare &amp; data for real-world impact
            </h2>
            <p className="text-[16px] text-[#6b7280] dark:text-[#9ca3af] leading-relaxed mb-4">
            ...
            <div className="pt-8 border-t border-[#e5e7eb] dark:border-[#27272a]">
              <p className="text-[13px] font-semibold text-[#111111] dark:text-white uppercase tracking-widest mb-4">
                Languages
              </p>
              <div className="grid grid-cols-2 gap-3">
                {languages.map((l) => (
                  <div key={l.lang} className="flex items-center justify-between px-4 py-3 rounded-xl border border-[#e5e7eb] dark:border-[#27272a] bg-[#fafafa] dark:bg-[#1a1a1a]">
                    <span className="text-[14px] font-medium text-[#111111] dark:text-white">{l.lang}</span>
                    <span className="text-[12px] text-[#9ca3af] dark:text-[#6b7280]">{l.level}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="aspect-[4/3] rounded-2xl bg-[#f3f4f6] dark:bg-[#1a1a1a] border border-[#e5e7eb] dark:border-[#27272a] overflow-hidden flex items-center justify-center text-[#d1d5db] dark:text-[#3f3f46]">
            ...
            <div className="rounded-2xl border border-[#e5e7eb] dark:border-[#27272a] bg-white dark:bg-[#1a1a1a] p-6">
              <p className="text-[13px] font-semibold text-[#111111] dark:text-white uppercase tracking-widest mb-4">
                Honours &amp; Awards
              </p>
              <ul className="flex flex-col gap-3">
                {awards.map((a) => (
                  <li key={a} className="flex items-start gap-3 text-[14px] text-[#6b7280] dark:text-[#9ca3af] leading-snug">
